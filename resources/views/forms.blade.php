<x-app-layout>
           ...
           <x-forms.body>
            <x-forms.input label="F Name" name="first_name" placeholder="Al Elliott" />
          </x-forms.body>
            ...
            >
              <label class="block text-sm">
                ...
                >
                  <input
                    class="form-input block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray "
                    placeholder="Jane Doe"
                  />
                  <div
            ...
            >
              ...
              <label class="block mt-4 text-sm">
                ...
                >
                  <input
                    class="block w-full pr-20 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                    placeholder="Jane Doe"
                  />
                  <button
