  ...
  <div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div>
        <h3 class="text-sm font-semibold mb-3" style="color: #2E7D32;">Services</h3>
        <ul class="space-y-2 text-sm">
          <li><a href="{{ route('pesticide.suggestor') }}" class="hover:underline">Pesticide Suggestor</a></li>
          <li><a href="{{ route('crop.planner') }}" class="hover:underline">Plant Suggestor</a></li>
          <li><a href="{{ route('fertilizer.suggestor') }}" class="hover:underline">Fertilizer Suggestor</a></li>
          <li><a href="{{ route('disease.scan') }}" class="hover:underline">Disease Scan</a></li>
        </ul>
      </div>
