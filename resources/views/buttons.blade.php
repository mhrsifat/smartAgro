...
<div class="container grid  mx-auto">
            <x-headings.page-title title="Buttons" />
            ...
            >
             ...
             <div class="flex flex-col flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
              <div>
                <x-ui.button text="Larger" size="larger" />
              </div>
              <div>
                <x-ui.button text="Large" size="large" />
              </div>
              <div>
                <x-ui.button text="Regular"  />
              </div>
              <div>
                <x-ui.button text="Click me" disabled="true" />
              </div>
              <div>
                <x-ui.button text="Click me" size="small"  />
              </div>
            </div>
            <div
            ...
            >
              <div>
                <x-ui.button-text-icon text="right" text-position="right" />
              </div>
              <div>
                <x-ui.button-text-icon text="left" text-position="left"  />
              </div>
              <div>
                <x-ui.button-icon-only shape="rounded-square" />
              </div>
              <div>
                <x-ui.button-icon-only icon="icons.edit" />
              </div>
